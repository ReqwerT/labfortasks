...
HOSTSWIN="$SCRIPTS/hosts_windows.ini"
HOSTSLIN="$SCRIPTS/hosts_lin.ini"
PRESEED_SCRIPT="$BASE_DIR/preseed/auto_debian_install.sh"
TARGET_IP="192.168.121.10"
